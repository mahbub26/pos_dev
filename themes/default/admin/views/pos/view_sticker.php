...
//                echo lang("customer") . ": " . ($customer->company && $customer->company != '-' ? $customer->company : $customer->name) . "<br>";
            ...
            <div style="border-left: 6px solid red; background-color: lightgrey; padding: 8px 8px 2px 8px;">
                ...
                <div>
                    <b><u>TERMS & CONDITIONS  =======mahbub===========</u></b><br>
                    ...
                    ② A non refundable service fee of $20 will be charged in the event of your water damaged device is not repairable.<br>
                    ...
                    ⑥ Due to the complexity of some devices, iFIX NYC is NOT responsible for any issues/damages during the repair.<br><br>
