        ...
        <div class="container">
            ...
            <div class="header-nav">
                ...
                <ul class="nav navbar-nav pull-right">
                    ...
                    <li class="dropdown hidden-xs"><a class="btn borange tip" title="<?= lang('Repair List') ?>" data-placement="bottom" href="<?= admin_url('sales/repair_list') ?>"><i class="fa fa-wrench"></i><span class="padding05"><?= lang('REPAIRS') ?></span></a></li>
                    <li class="dropdown hidden-xs"><a class="btn bdarkGreen tip" title="<?= lang('product') ?>" data-placement="bottom" href="<?= admin_url('products') ?>"><i class="fa fa-barcode"></i></a></li>
                    ...
                    <?php if ($info) { ?>
                        <li class="dropdown hidden-sm">
                            <a class="btn bblue tip" title="<?= lang('notifications') ?>" data-placement="bottom" href="#" data-toggle="dropdown">
                                <img src="/assets/images/bell.gif" alt="Notification" width="25" height="25">
                ...
                <div class="sidebar-nav nav-collapse collapse navbar-collapse" id="sidebar_menu">
                    <ul class="nav main-menu">
                        ...
                        <?php if ($Owner || $Admin) { ?>
                            ...
                            <li class="mm_sales <?= strtolower($this->router->fetch_method()) == 'sales' ? 'mm_pos' : '' ?>">
                                ...
                                -->
                                    ...
                                    <li id="sales_repair_list">
                                        <a style="padding-left: 30px" class="submenu" href="<?= admin_url('sales/repair_list'); ?>?clear=yes">
                                            <i class="fa fa-heart"></i>
                            ...
                            <?php if ($Owner) { ?>
                            <li id="auth_users" class="mm_notifications">
                        ...
                        <?php
                            ...
                            <li class="mm_products">
                                ...
                                <ul>
                                    <li id="products_index">
                                        <a class="submenu" style="padding-left: 30px" href="<?= admin_url('products'); ?>">
                                    ...
                                    <li id="products_sheet">
                                        <a class="submenu" style="padding-left: 30px" href="<?= admin_url('products/print_barcodes'); ?>">
                            ...
                            <li class="mm_sales <?= strtolower($this->router->fetch_method()) == 'sales' ? 'mm_pos' : '' ?>">
                                ...
                                <ul>
                                    ...
                                    <li id="pos_sales">
                                        <a class="submenu" style="padding-left: 30px" href="<?= admin_url('pos/sales'); ?>">
                                            <i class="fa fa-heart"></i><span class="text"> <?= lang('pos_sales'); ?></span>
                                        </a>
                                    </li>
                                    <li id="sales_repair_list">
                                        <a class="submenu" style="padding-left: 30px" href="<?= admin_url('sales/repair_list'); ?>">
                            ...
                            <li class="mm_purchases">
                                ...
                                <ul>
                                    <li id="purchases_index">
                                        <a class="submenu" style="padding-left: 30px" href="<?= admin_url('purchases'); ?>">
                                    ...
                                    <li id="purchases_expenses">
                                        <a class="submenu" style="padding-left: 30px" href="<?= admin_url('purchases/expenses'); ?>">
                            ...
                            <li class="mm_returns">
                                ...
                                <ul>
                                    <li id="returns_index">
                                        <a class="submenu" style="padding-left: 30px" href="<?= admin_url('returns'); ?>">
                                            <i class="fa fa-random"></i><span class="text"> <?= lang('list_returns'); ?></span>
                                        </a>
                                    </li>
                                    <!--
                            ...
                            <li class="mm_auth mm_customers mm_suppliers mm_billers">
                                ...
                                <ul>
                                    ...
                                    <li id="customers_index">
                                        <a class="submenu" style="padding-left: 30px" href="<?= admin_url('customers'); ?>">
                                            <i class="fa fa-users"></i><span class="text"> <?= lang('list_customers'); ?></span>
                                        </a>
                                    </li>
                                    <!--
                                    ...
                                    <li id="suppliers_index">
                                        <a class="submenu" style="padding-left: 30px" href="<?= admin_url('suppliers'); ?>">
                                            <i class="fa fa-users"></i><span class="text"> <?= lang('list_suppliers'); ?></span>
                                        </a>
                                    </li>
                                    <!--
