...
class Welcome extends MY_Controller
{
    ...
    public function index()
    {
        ...
        $this->data['total_pos_sales'] = $this->db_model->getTotalPosSales();
        $this->data['total_repair_sales'] = $this->db_model->getTotalRepairSales();
        ...
        $this->data['total_ready_notified'] = $this->db_model->getTotalReadyNotified();
        $this->data['total_ready_notified_paid'] = $this->db_model->getTotalReadyNotifiedPaid();
        $this->data['total_ready_notified_due'] = $this->db_model->getTotalReadyNotifiedDue();
