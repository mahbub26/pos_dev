...
class Sales_model extends CI_Model
{
    ...
    {
        $this->db->select('sales.id,sales.customer,sales.reference_no,companies.name as nam,repair_history.created_by,repair_history.created_date,repair_history.repair_note,repair_history.repair_status,repair_history.signature,users.username')
